...
initial 
begin
$monitor("Time = %t|rst_n = %b|start = %b|data_valid = %b|x_in = %d|w_in = %d|bias = %d|done = %b|final_output = %d",$time,rst_n,start,data_valid,x_in,w_in,bias,done,final_output);
	clk   = 0;       rst_n      = 0;
